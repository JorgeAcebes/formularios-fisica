...
&\underline{\text{Obtención términos y niveles moleculares:}}\\
...
\end{array}
\\
&S=s_i \oplus s_k \;\;\;\; \deg\text{T.M.: }\mathcal{z}(2S+1),\;\;\; \; \mathcal{z}=1\text{ if $\Sigma$, 2 if other T.M.}
\\ 
&\centerdot \text{e$^-$ no equivalentes (i.e. O.M. sin superíndices) \;\;\; $T\equiv$ términos de la forma $^{2S+1}\Lambda$}
\end{align*}
\begin{center}
