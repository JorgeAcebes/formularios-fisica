...
\text{absorción:}\\
n_i<n_f\\
\text{free: }n_f \!\rightarrow \!\infty
\end{array}
\right.\\
&\underline{\text{Átomos hidrogenoides: }} \text{ $Y_l^m (\theta, \phi)\equiv$arm. esf. (norm.) \; nodos radiales: $\#n_r = n - l -1$} 
...
&\underline{\text{Hamiltoniano estructura fina}} \; 
\begin{array}{cc}
\text{correción}  \\
\text{relativista}
\end{array}
\;\mathcal{\hat{H}}=mc^2+  \frac{\hat{\vec{p}}}{2m}\!+\!\hat{U}(r) + H_{mv} + H_{S-O} + H_{D}\\
...
\end{array}
\right.\\
&\Delta E_2 = -E_n \frac{Z^2 \alpha^2}{2nl (l+1)(l+1/2)}[j(j+1)-l(l+1)-s(s+1)] \; \; \; \; \Delta E_3 = -E_n \frac{Z^2 \alpha^2}{n}\\
...
\end{align*}
\underline{\text{Otros}}\text{: $-E_n \equiv$ E. ioniz.}\;\;\;\;$\hat{U}=-\frac{Ze^2}{4\pi\varepsilon_0 r}$\;\;\;$\Delta E_{\text{fina, (1,2,3), s=1/2}}^{\text{hidrognes}\;(\uparrow j\downarrow \Delta E)}= E_n\frac{Z^2 \alpha^2}{n^2}\left[\frac{n}{j+\tfrac{1}{2}}-\tfrac{3}{4}\right]$\\
